    ...
    <>
      ...
      <main className="mx-auto max-w-[1960px] p-4">
        ...
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4 mb-1">
          <div className="after:content relative flex h-[410px] flex-col items-center justify-end gap-5 overflow-hidden rounded-lg bg-white/10 px-6 pb-11 pt-14 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0 mb-3">
            <Voting />
