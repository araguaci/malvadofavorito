    ...
    <>
      ...
      <main className="mx-auto max-w-[1960px] p-4">
        ...
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4">
          <div className="after:content relative mb-5 flex h-[629px] flex-col items-center justify-end gap-4 overflow-hidden rounded-lg bg-white/10 px-6 pb-10 pt-64 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0">
            <div className="absolute inset-0 flex items-center justify-center opacity-20">
              <span className="flex max-h-full max-w-full items-center justify-center">
                <Hexagon />
              </span>
              <span className="absolute left-0 right-0 bottom-0 bg-gradient-to-b from-black/0 via-black to-black"></span>
            </div>
            <Voting />
          ...
          <span onClick={scrollToTop} className="text-neutral-700 w-4 h-4 fixed bottom-2 right-1 p-5 zindex bg-slate-200 opacity-50 rounded-full">
            <FontAwesomeIcon icon={faArrowUp} className="absolute top-2 left-2 size-6" />
          </span>
      </main>
