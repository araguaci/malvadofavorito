      ...
      <main className="mx-auto max-w-[1960px] p-4">
        ...
        <div className="columns-1 gap-4 sm:columns-2 xl:columns-3 2xl:columns-4 mb-1">
          <div className="after:content relative flex h-[611px] flex-col items-center justify-end gap-5 overflow-hidden rounded-lg bg-white/10 px-6 pb-10 pt-14 text-center text-white shadow-highlight after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:shadow-highlight lg:pt-0 mb-3">
            ...
            <a
              className="pointer z-10 rounded-lg border border-white bg-green-700 px-3 py-2 text-sm font-semibold text-yellow transition hover:bg-yellow-300 hover:text-green-900 md:mt-1 mb-11"
